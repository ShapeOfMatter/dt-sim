...
\label{fig:extra1}
  \Description{Eight line-graphs; four in each column. The left column are all for Oblivious-transfer based protocols,
   and the right column are all for beaver-tripple based protocols.
   The four rows of two graphs each are for the four different test-power configurations.
   each graph shows data for five data-series: the secure version and the four mutations.}
\end{figure*}
